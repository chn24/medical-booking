...
function InformationForm(props) {
    ...
    const handleClick = () => {
        ...
        if (!firstName.error && firstName.isChanged
            && !lastName.error && lastName.isChanged 
            && !phoneNumber.error.isError && phoneNumber.isChanged) {
            context.setCustomer({
                title,
                firstName,
                lastName,
                ...
                >
                    <Stack>
                        ...
                        <Box sx={{
                            ...
                            >
                            {
                                phoneNumber.error.required ? '*Required' 
